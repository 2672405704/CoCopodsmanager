...
Pod::Spec.new do |spec|
  ...
  spec.name         = "CoCopodsmanager"
  spec.version      = "1.0.3"
  spec.summary      = "A first short description of CoCopodsmanager."
  ...
  spec.source       = { :git => "https://github.com/2672405704/CoCopodsmanager.git", :tag => "1.0.0" }
  ...
  spec.source_files  = "ManagerTool", "ManagerTool/**/*.{h,m}"
